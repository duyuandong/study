...
public class FileViewer {
  ...
  private static List<String> listFile(
      List<String> lstFileNames, File f, String suffix, boolean isdepth) {
    // 若是目录, 采用递归的方法遍历子目录
    if (f.isDirectory()) {
      File[] t = f.listFiles();
  ...
  public static void main(String[] args) {
    //
    List<String> listFiles = getListFiles("C:\\Users\\Administrator\\AppData\\Roaming", "", true);
    listFiles.forEach(i -> System.out.println(i));
  }
}
